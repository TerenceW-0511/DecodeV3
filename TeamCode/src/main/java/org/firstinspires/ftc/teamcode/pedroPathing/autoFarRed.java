...
@Autonomous(name = "Far Red", group = "Blue")
public class autoFarRed extends OpMode {
    ...
    private final Pose startPose = new Pose(40, 6.5, Math.toRadians(180)).mirror(); // Start Pose of our robot.
    //    private final Pose shootPreloadPose = new Pose(40,8.6,Math.toRadians(180));
    private final Pose grabPose1 = new Pose(9.5,6.5,Math.toRadians(180)).mirror();
    private final Pose regrabPose = new Pose(9.5,10,Math.toRadians(180)).mirror();
    private final Pose controlRegrab = new Pose(23.9,8.2).mirror();
    private final Pose scorePose1 = new Pose(56.7,16.6,Math.toRadians(190)).mirror();
    private final Pose grabPose2 = new Pose(16.5,35.2,Math.toRadians(180)).mirror();
    private final Pose grabPose3 = new Pose(7,32.5,Math.toRadians(97)).mirror();
    private final Pose controlPickup3 = new Pose(10.3,4);
    private final Pose controlPickup2 = new Pose(54.8,36).mirror();
    private final Pose scorePose2 = new Pose(50,8.6,Math.toRadians(142)).mirror();
    private final Pose grabPoseMiddler = new Pose(10,28.9,Math.toRadians(109)).mirror();
    private final Pose controlMiddler = new Pose(17.3,8.6).mirror();
